...
icon = Image.open("youtube-logo-png-2069.png")
st.set_page_config(page_title="Youtube Data Harvesting and Warehousing",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This app is created by *Srikanth!*"""})
...
mydb = sql.connect(host="localhost",
                   user="root",
                   password="test12345@10",
                   database="youtube_db"
                   )
mycursor = mydb.cursor(buffered=True)

# BUILDING CONNECTION WITH YOUTUBE API
api_key = "AIzaSyC84edUW-GA-NPV6wl-mUXAE0eizDLPRIw"
